...
const Involvement = () => {
  ...
  useEffect(() => {
    const involvementPage = async () => {
      analytics.logEvent('involvment_page')
    }
  ...
  return (
    ...
    <>
      <Helmet>
        <title> Join the Cause! Black Female Financial Empowerment | TPP </title>
        <meta property="og:title" content="Join the Cause! | The Prosp(a)rity Project" />
        <meta property="og:image" content={logo} />
        <meta property="og:description" content="The Prosp(a)rity Project is always looking for volunteers to help out the cause, see how you can help out today!" />
      </Helmet>
      ...
      <MailingList addedClass={"involvement-mailinglist-mobile"} />
    </>
  );
};

...
const TeamPage = () => {
  ...
  let currentPath = location.pathname.split("/team/team-member/").slice(-1)[0].split("-").join(" ");

  // let teamName = _.title (currentPath.split('-')) 
  //  console.log(currentPath);

  let obj = infoArray.find(o => o.name.toLowerCase() === currentPath);
  // console.log(obj)
      ...
      <div className="main-mobile-header team-page">
        ...
        <div className="team-page-header__content-container">
          ...
          <div className="team-page-header__text-container">
            ...
            <p className="team-page-header__text-container--title">
              {obj.title}
            </p>
